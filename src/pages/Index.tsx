    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="pt-5">
        <div className="flex items-center justify-between px-5 mb-3">
          ...
          <button className="text-[12px] font-heading font-medium text-primary flex items-center gap-0.5">
            ...
            [...featuredSalons, ...nearbySalons].slice(0, 3).map((salon) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-[12px] font-heading font-semibold text-primary-foreground bg-primary px-4 py-2 rounded-xl active:scale-95 transition-transform flex-shrink-0"
                >
                  Book
                </button>
              </div>
